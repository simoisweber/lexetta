...
class TrainingConfig(BaseModel):
    ...
    max_grad_norm: float = 1.0 # global L2 norm threshold for gradient clipping; gradients with larger norm are rescaled to this value before the optimizer step
